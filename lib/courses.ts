...
export const COURSES: CourseInfo[] = [
  {
    ...
    includes: [
      "ไฟล์โจทย์ 70 ข้อ (PDF)",
      "ไฟล์เฉลยละเอียดทีละขั้นทุกข้อ (PDF)",
      "กระดาษคำตอบ (PDF)",
      "โควตาเข้าสอบออนไลน์ 1 ครั้ง พร้อมผลวิเคราะห์",
    ],
    highlights: [
      ...
      "ไฟล์ทุกไฟล์ใส่ลายน้ำชื่อผู้ซื้อ กลับมาโหลดได้ตลอดที่หน้า “คอร์สของฉัน”",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "ไฟล์ใส่ลายน้ำชื่อผู้ซื้อ กลับมาโหลดได้ตลอดที่หน้า “คอร์สของฉัน”",
    ],
  ...
  },
  {
    ...
    includes: [
      "ไฟล์โจทย์ + เฉลยละเอียด + กระดาษคำตอบ Mock TPAT3 (PDF)",
      "โควตาเข้าสอบออนไลน์ 1 ครั้ง พร้อมผลวิเคราะห์",
