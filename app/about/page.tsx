        ...
        <article className="mx-auto max-w-3xl px-5 py-14 md:py-16">
          ...
          <section id="story" className="scroll-mt-24">
            ...
            <div className="mt-6 space-y-6 text-[1.08rem] leading-[1.9] text-ink/85 md:text-[1.15rem]">
              ...
              <p>
                ...
                และที่นั่นนี่แหละที่ทำให้พี่ได้เห็นสังคมที่ต่างออกไปโดยสิ้นเชิง ทุกคนขยัน ทุกคนพากันเรียน
              ...
              <p>
                ไฟนั้นพาพี่มาถึงคณะวิศวกรรมศาสตร์ จุฬาฯ ด้วยคะแนน{" "}
                <strong className="text-ink">TPAT3 76 และ A-Level Physics 86</strong>{" "}
                และพาพี่มาเจอเพื่อน ๆ ที่คิดเหมือนกัน
          ...
          <section id="why-tpat3" className="mt-14 scroll-mt-24 border-t border-grid pt-12">
            ...
            <div className="mt-6 space-y-6 text-[1.08rem] leading-[1.9] text-ink/85 md:text-[1.15rem]">
              ...
              <p>
                พี่จึงต้องขวนขวายหาข้อมูลด้วยตัวเอง เรียนหลายที่ ซื้อหนังสือหลายเล่ม
                แล้วเอามาประกบกันเองว่า TPAT3 น่าจะออกแนวไหน
              </p>
              <p>
                แต่ในวันสอบจริง พี่พบว่าข้อสอบ TPAT3{" "}
                <strong className="text-ink">ยากกว่าที่พี่เตรียมมาไว้เยอะมาก</strong> ส่วนหนึ่งอาจเพราะพี่ตื่นเต้นและความรนด้วย
              </p>
              <p>
              ...
              <p>
                อีกเรื่องที่พี่อยากฝากไว้ คือน้อง ๆ ส่วนใหญ่มักมองข้าม TPAT3 บ้างก็เพราะคิดว่าง่าย
                บ้างก็เพราะเนื้อหาคล้ายฟิสิกส์ เลยบอกตัวเองว่าเดี๋ยวค่อยเก็บทีหลังก็ได้ แต่อย่าลืมนะครับว่า
                TPAT3 นี่แหละคือวิชาที่มี<strong className="text-ink">สัดส่วนคะแนนสูงสุดในการยื่นเข้าวิศวะ</strong>{" "}
                พูดง่าย ๆ คือเป็นตัวชี้ขาดที่สุดว่าเราจะติดหรือไม่ติด
                เพราะฉะนั้นพี่อยากให้น้อง ๆ โฟกัสกับ TPAT3 ให้มากกว่านี้
              </p>
              <p>
