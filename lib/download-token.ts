 ...
 *
 * ค่าที่ร้านใช้อยู่: ลิงก์ **ไม่มีวันหมดอายุ** (config.download.expiryHours = 0)
 * ตั้ง DOWNLOAD_EXPIRY_HOURS เป็นจำนวนบวกเมื่อไหร่ ระบบจะบังคับวันหมดอายุให้ทันที
 */
export interface DownloadPayload {
   ...
   * (เช่น วันหลังกลับมาตั้งอายุ 6 เดือน ลูกค้าเดิมได้ตามด้วยทันที ไม่ต้องขอลิงก์ใหม่)
   */
  iat?: number;
  /**
