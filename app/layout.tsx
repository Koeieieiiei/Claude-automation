...
const DESCRIPTION =
  "ซ้อม TPAT3 เหมือนสนามจริง — ทำข้อสอบ 70 ข้อบนเว็บ จับเวลา 3 ชั่วโมง ส่งแล้วรู้คะแนน อันดับ และบทที่ต้องซ่อมทันที พร้อมเฉลยละเอียดทีละขั้นและเนื้อหาทั้งหมดสำหรับสอบ TPAT3 เริ่ม ฿159";
