...
export const config = {
  ...
  download: {
    ...
    /**
     * อายุลิงก์ดาวน์โหลด (ชั่วโมง) — **0 = ไม่มีวันหมดอายุ**
     * ค่าที่ร้านใช้อยู่: 2160 ชม. = 3 เดือน (เจ้าของกำหนด 2026-07-25)
     *
     * อายุคิดจาก "เวลาที่ออกลิงก์ (iat ในโทเค็น) + ค่านี้" ไม่ได้ฝังวันหมดอายุตายตัว
     * เปลี่ยนค่านี้เมื่อไหร่ ลิงก์ที่ออกไปแล้วจึงยืด/หดตามทันที ไม่ต้องออกลิงก์ใหม่
     */
