...
เปลี่ยนประสบการณ์จาก "ซื้อแล้วได้ไฟล์" → "ซื้อแล้วเข้าห้องสอบออนไลน์": ทำโจทย์ 70 ข้อในเว็บ
จับเวลา 3 ชั่วโมง (1 อีเมลทำได้ 1 รอบ) ส่งแล้วได้ผลวิเคราะห์ละเอียด — อันดับ/ค่าเฉลี่ย/SD/สูงสุด/ต่ำสุด
กราฟแจกแจงคะแนน วิเคราะห์รายข้อ (บท · ถูก-ผิด · ความยาก · %คนตอบถูก · คำแนะนำ 6 แบบ)
พร้อมไฟล์โจทย์+เฉลย (ลายน้ำ) แนบท้ายผล
...
- [ ] เพิ่ม `product_id` ในตาราง orders แล้วต่อ `findEntitlement()` ให้เช็คผู้ซื้อจริง (ตอนนี้เช็คเฉพาะผู้ซื้อจำลอง)
- [ ] แก้อีเมลส่งของ + หน้า success: สินค้าที่มีชุด Mock ให้ส่ง "ลิงก์เข้าห้องสอบ" แทนลิงก์โหลดโจทย์/เฉลยทันที
- [ ] อัปโหลดรูปหน้าโจทย์ (`assets/exam-pages/`) ขึ้น Supabase Storage หรือ generate ตอน build
...
- [ ] อัปเดต FAQ บนหน้าแรกให้ตรงกับ flow ใหม่
