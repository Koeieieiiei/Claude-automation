          ...
          <div className="px-6 py-8 md:px-10">
            ...
            <ul className="mt-6 space-y-2.5 text-sm leading-relaxed text-ink/75">
              {[
                ...
                "ทำเสร็จกด “ส่งกระดาษคำตอบ” จะได้รับผลวิเคราะห์ละเอียดทันที พร้อมไฟล์โจทย์และเฉลยแนบท้าย",
                "ระหว่างสอบยังไม่เห็นไฟล์เฉลย — เปิดให้หลังส่งกระดาษคำตอบแล้วเท่านั้น",
              ].map((r) => (
