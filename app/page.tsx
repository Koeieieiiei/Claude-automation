      ...
      <section id="faq" className="scroll-mt-20 bg-paper">
        <div className="mx-auto max-w-2xl px-5 py-14">
          ...
          <div className="mt-7 divide-y divide-grid border-y border-grid">
            ...
            <FaqItem
              q="ได้อะไรบ้าง?"
              a="ชุด Mock ได้ไฟล์ PDF 3 ไฟล์ (โจทย์ + เฉลยละเอียด + กระดาษคำตอบ) พร้อมสิทธิ์ทำข้อสอบออนไลน์ 1 รอบและผลวิเคราะห์ · สรุปเนื้อหา TPAT3 ได้ 2 ไฟล์ (เนื้อหา + สูตรล้วน) · ลิงก์ดาวน์โหลดใช้ได้ 3 เดือน"
            />
            <FaqItem
              q="ขอคืนเงินได้ไหม?"
