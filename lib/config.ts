...
export const config = {
  ...
  download: {
    ...
    /**
     * อายุลิงก์ดาวน์โหลด (ชั่วโมง) — **0 = ไม่มีวันหมดอายุ** และเป็นค่าเริ่มต้น
     * (เจ้าของร้านสั่งเลิกระบบหมดอายุ 2026-07-25 — ลูกค้าเปิดลิงก์เดิมได้ตลอดไป
     * รวมถึงลิงก์เก่าที่เคยออกตอนยังมีวันหมดอายุด้วย)
     * ตั้งเป็นจำนวนบวกเมื่อไหร่ ระบบจะกลับมาบังคับวันหมดอายุทั้งตอนออกและตอนตรวจลิงก์
     */
